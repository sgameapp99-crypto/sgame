...
onMounted(async () => {
  try {
    const path = (route.query.path as string) || '/legacy/www.playsport.cc/member/';
    const CACHE_KEY = `member_cache_${path}`;
